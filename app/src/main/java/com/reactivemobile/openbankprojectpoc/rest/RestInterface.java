...
public interface RestInterface {
    ...
    @GET("https://apisandbox.openbankproject.com/obp/v2.2.0/banks")
    Call<Banks> getBanks();

    @GET("https://apisandbox.openbankproject.com/obp/v2.2.0/banks/{bank_id}/accounts/private")
    Call<BankAccounts> getPrivateBankAccountsForBank(@Path("bank_id") String bankId, @Header("Authorization") String authHeader);

    @GET("https://apisandbox.openbankproject.com/obp/v2.2.0/banks/{bank_id}/accounts/{account_id}/{view_id}/account")
